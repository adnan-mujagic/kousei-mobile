    ...
    return (
        ...
        <View style={{borderBottomWidth:0.2 , borderBottomColor:grayColor()}}>
            <View style={[generalMainStyle.row, {padding:10}]}>
                ...
                <Image source={{uri: item.creator.profile_picture}} style={{height:30, width:30, resizeMode:"cover", borderRadius:15, marginRight:10, borderColor:grayColor(), borderWidth:0.5}}/> 
                </TouchableOpacity>
                <TouchableOpacity disabled={handleDisabled} onPress={()=>onPostUserPicturePress()}>
                <Text style={{fontWeight:"bold", fontSize:15}}>{item.creator.username}</Text>
                </TouchableOpacity>
            </View>
