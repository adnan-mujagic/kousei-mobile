        ...
        <View style={{borderBottomWidth:0.5 , borderBottomColor:grayColor()}}>
            ...
            <View>
                ...
                <View style={[generalMainStyle.row, {marginHorizontal:10, marginBottom:10,}]}>
                    ...
                    <TouchableOpacity style={{marginLeft:5}} onPress={()=>setCommentsOpen(!commentsOpen)}><Octicons name="comment" size={22} color="black" /></TouchableOpacity>
                </View>
                ...
                {commentsOpen && <View style={[generalMainStyle.row, {justifyContent:"space-between", marginBottom:10}]}>
                        <TextInput value={yourComment} onChangeText={(text)=> setYourComment(text)} style={{paddingHorizontal:10}} placeholder="Your comment..." />
                        <TouchableOpacity style={{padding:8, margin:2,borderRadius:10,}} disabled={yourComment==""}>
                            <Text style={{color:yourComment==""? grayColor(): primaryColor()}}>Post</Text>
                        </TouchableOpacity>
                </View>}
            </View>
        </View>
